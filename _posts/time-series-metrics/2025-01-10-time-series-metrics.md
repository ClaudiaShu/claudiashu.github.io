...
![Symmetric Distribution]({{ site.baseurl }}/posts/time-series-metrics/misc/mean_vs_median.png)
...
![Effect of Outliers on Mean vs Median]({{ site.baseurl }}/posts/time-series-metrics/misc/outliers_effect.png)
